                  ...
                  children: [
                    Checkbox(
                      value: answer.options
                          .contains(widget.question.otherText ?? 'Outro'),
                      checkColor: kDarkBlackColor,
                      activeColor: kPrimaryColor,
                      onChanged: (value) {
                        if (value!) {
                          setState(() {
                            answer.options
                                .add(widget.question.otherText ?? 'Outro');
                            otherSelected = true;
                          });
                          widget.onChange(
                            answer,
                          ...
                          setState(() {
                            otherSelected = false;
                            answer.options
                                .remove(widget.question.otherText ?? 'Outro');
                          });
                          widget.onChange(
                            answer,
                          );
                    ...
                    if (otherSelected) ...[
                      ...
                      SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (value) {
                            answer = answer.copyWith(descriptiveAnswer: value);
              ...
              if (!widget.question.hasOther &&
                ...
                SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      focusedBorder: const OutlineInputBorder(
                        borderSide: BorderSide(color: kBodyTextPrimaryColor),
                      ),
                      enabledBorder: const OutlineInputBorder(
                        borderSide: BorderSide(
                          color: kBodyTextPrimaryColor,
                      ...
                      labelText: widget.question.otherText,
                      labelStyle: const TextStyle(color: kBodyTextPrimaryColor),
                    ),
                    onChanged: (value) {
                      answer = answer.copyWith(descriptiveAnswer: value);
                      widget.onChange(answer);
